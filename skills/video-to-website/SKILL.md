...
**Requires FFmpeg and FFprobe on PATH.** Install them first if not already available (`winget install Gyan.FFmpeg` or from ffmpeg.org) before running the steps below.
